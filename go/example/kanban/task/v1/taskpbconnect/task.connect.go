...
package taskpbconnect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/betareduced/proto/go/example/kanban/task/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	TaskServiceName = "example.kanban.task.v1.TaskService"
)
...
func NewTaskServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TaskServiceClient {
	...
	taskServiceMethods := v1.File_example_kanban_task_v1_task_proto.Services().ByName("TaskService").Methods()
...
// GetTask calls example.kanban.task.v1.TaskService.GetTask.
...
func (UnimplementedTaskServiceHandler) CreateTask(context.Context, *connect.Request[v1.CreateTaskRequest]) (*connect.Response[v1.CreateTaskResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("example.kanban.task.v1.TaskService.CreateTask is not implemented"))
}
